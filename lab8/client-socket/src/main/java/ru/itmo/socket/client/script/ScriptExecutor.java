package ru.itmo.socket.client.script;
...
import ru.itmo.socket.common.exception.ScriptRecursionException;
...
public class ScriptExecutor {
  ...
  private ExitCode launchCommand(String[] userCommand) {
    ...
    switch (userCommand[0]) {
      ...
      case "sum_of_distance" -> mainController.sumOfDistance();
      case "filter_by_distance" -> mainController.filterByDistance();
      case "filter_contains_name" -> mainController.filterContainsName();
